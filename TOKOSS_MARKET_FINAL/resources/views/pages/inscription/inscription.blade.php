      ...
      <div class="container">
        <div class="row no-gutters slider-text align-items-center justify-content-center">
          <div class="col-md-9 ftco-animate text-center">
          	<p class="breadcrumbs"><span class="mr-2"><a href="/">INSCRIPTION</a></span> <span>//</span> <span>INSCRIVEZ-VOUS</span></p>
      ...
      <div class="container">
        <div class="row justify-content-center">
          <div class="col-xl-7 ftco-animate">
						<form action="{{ route('inscription.store') }}" method="POST" enctype="multipart/form-data" class="billing-form">
						@csrf
				...
				<div>
				  <p>Pour vous connecter <a href="{{route('connexion')}}">Cliquez ici</a></p>
			  </div>
