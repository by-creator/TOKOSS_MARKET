      ...
      <div class="container">
        <div class="row justify-content-center">
          <div class="col-xl-7 ftco-animate">
						<form form action="{{ route('connexion.store') }}" method="POST" enctype="multipart/form-data" class="billing-form" class="billing-form">
						@csrf	
				...
				<div>
				  <p>Mot de passe oublié ? <a href="{{ route('connexion.password_reset') }}">Cliquez ici</a></p>
				</div>
