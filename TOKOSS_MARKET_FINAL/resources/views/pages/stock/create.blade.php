    			...
    			<div class="col-md-12 ftco-animate">
    				<div class="stock-list">
	    				<table class="table">
						    ...
						    <tbody>
							<input id="defaulterrormessage" type="hidden" th:value="{{$stockData = App\Models\Stock::where('user_id', '=',Session::get('id'))->get();}} ">
							  ...
							  <td>
									...
									<a class="btn btn-primary py-3 px-5"  href="{{route('stock.edit',['id'=>$stock->id])}}" onClick = "return confirm('Voulez-vous modifier ce stock ?')">+</a>
								
							  </td>  

							  <td>
								
							 	 <a class="btn btn-primary py-3 px-5" href="{{route('stock.delete',['id'=>$stock->id])}}" onClick = "return confirm('Voulez-vous supprimer ce stock ?')">x</a>
