			...
			@csrf
				  ...
				  <div class="col-md-6">
	                <div class="form-group">
	                  ...
	                  <input name="firstname" type="text" class="form-control" value="{{$search_user->firstname}}" required="Ce champ est obligatoire">
	                </div>
	              </div>
	              ...
	              <div class="col-md-6">
	                <div class="form-group">
	                  ...
	                  <input name="lastname" type="text" class="form-control" value="{{$search_user->lastname}}" required="Ce champ est obligatoire">
	                </div>
                </div>
		            ...
		            <div class="col-md-6">
	                  ...
	                  <input name="adress" type="text" class="form-control" value="{{$search_user->adress}}" required="Ce champ est obligatoire">
	                </div>
		            </div>
		            <div class="col-md-6">
		            	<div class="form-group">
		            		<label for="city">Ville</label>
	                  <input name="city" type="text" class="form-control" value="{{$search_user->city}}" required="Ce champ est obligatoire">
	                </div>
		            </div>
		            <div class="w-100"></div>
		            <div class="col-md-6">
	                <div class="form-group">
	                  ...
	                  <input name="tel" type="number" class="form-control" value="{{$search_user->tel}}" required="Ce champ est obligatoire">
	                </div>
	              </div>
	              <div class="col-md-6">
	                <div class="form-group">
	                	<label for="email">Email </label>
	                  <input name="email" type="email" class="form-control" value="{{$search_user->email}}" required="Ce champ est obligatoire">
	                </div>
                </div>
                <div class="w-100"></div>
				<div class="form-group">
